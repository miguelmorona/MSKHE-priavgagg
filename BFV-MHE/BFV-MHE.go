...
func main() {	
	...
	file, err := os.OpenFile("bfv-results-flta.txt", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0666)	
	check(err)
	defer file.Close() 
	l := log.New(file, "", 0)
	...
	NumModelParameters := 16384000 // This equals 2^13*2000
...
func evalPhase(params bgv.Parameters, NGoRoutine int, encInputs [][]*rlwe.Ciphertext) (encRes []*rlwe.Ciphertext) {
